...
$string['addoption'] = 'Ajouter l\'option';
...
$string['errorcannotdeleteoption'] = 'Erreur de suppression d\une option (valeur utilisée)';
$string['cannotdeleteoption'] = 'Cette option est utilisée. Elle ne peut être supprimée. Suivez le lien pour trouver les usages.';
...
$string['setlistable'] = 'Montrer dans la liste';
$string['setnotlistable'] = 'Ne pas montrer dans la liste';
...
$string['submitissue'] = 'Soumettre le ticket';
$string['submitoption'] = 'Ajouter l\'option';
...
$string['updateoption'] = 'Mettre à jour l\'option';
